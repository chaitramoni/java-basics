...
public class Runner {
	...
	public static void main(String[] args) {
		...
		Application ref2 = spring.getBean(Application.class);
		System.out.println(ref2);
		
		Bus ref3 = spring.getBean(Bus.class);
		System.out.println(ref3);
		
		Chocolate ref4 = spring.getBean(Chocolate.class);
		System.out.println(ref4);

		City ref5 = spring.getBean(City.class);
		System.out.println(ref5);
		
		Cycle ref6 = spring.getBean(Cycle.class);
		System.out.println(ref6);
		
		Fish ref7 = spring.getBean(Fish.class);
		System.out.println(ref7);
		
		Girl ref8 = spring.getBean(Girl.class);
		System.out.println(ref8);
		
		God ref9 = spring.getBean(God.class);
		System.out.println(ref9);
		
		Mall ref10 = spring.getBean(Mall.class);
		System.out.println(ref10);
		
		Mask ref11 = spring.getBean(Mask.class);
		System.out.println(ref11);
		
		Milk ref12 = spring.getBean(Milk.class);
		System.out.println(ref12);
		
		Park ref13 = spring.getBean(Park.class);
		System.out.println(ref13);
		
		Patient ref14 = spring.getBean(Patient.class);
		System.out.println(ref14);
		
		Temple ref15 = spring.getBean(Temple.class);
		System.out.println(ref15);
		
		Area ref16 = spring.getBean(Area.class);
