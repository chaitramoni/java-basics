	...
	<form action="technology" method="post">
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="technologyName"
					value="${entity.technologyName}" /></td>
			<tr>
			<tr>
				<td>Technology Language</td>
				<td><select name = "language">
				<option value="${entity.language}">SELECT</option>
			...
			<tr>
				...
				<td><input type="text" name="supportFrom"
					value="${entity.supportFrom}" /></td>
			<tr>
			<tr>
				<td>Support To</td>
				<td><input type="text" name="supportTo"
					value="${entity.supportTo}" /></td>
			<tr>
			<tr>
				<td>License No</td>
				<td><input type="text" name="licenseNo"
					value="${entity.licenseNo}" /></td>
			<tr>
			<tr>
				<td>Open Source</td>
				<td><select name = "openSource">
				<option value="${entity.openSource}">SELECT</option>
